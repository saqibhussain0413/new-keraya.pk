            ...
            <div class="row">
                ...
                <div class="col s12 m8">
                    <div class="contact-content">
                        ...
                        <form id="contact-us" action="{{route('contact.message')}}" method="POST" class="form-control">
                            @csrf
                            <input type="hidden" name="mailto" value="{{ $contactsettings[0]['email'] ?? 'keraya.pk@gmail.com' }}">
                            @auth
