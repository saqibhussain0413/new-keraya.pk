<div class="navbar-fixed">
    <nav class="darken-4 navDesign" id="navBar">
        <div class="container">
            <div class="nav-wrapper">
                ...
                <ul class="right hide-on-med-and-down">
                    <li class="{{ Request::is('/') ? 'active' : '' }}">
                       <a href="{{ route('home') }}"><span class="fas fa-home"></span> Home</a>
                    </li>
                    ...
                    @guest
                        <li>
                          <a href="{{ route('login') }}"><span class="fas fa-user"></span> Login/Register</a>
                        </li>
                    @else
                        <li>
