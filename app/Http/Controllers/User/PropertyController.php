...
class PropertyController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('user.properties.create',compact('features', 'propertyTypes'));
    }
    ...
    {
        $request->validate([
            'title'     => 'required:properties|max:255',
            'price'     => 'required',
            'purpose'   => 'required',
            'type'      => 'required',
            'bedroom'   => 'required',
        ...
        $typeID = PropertyTypes::select('property_type_ID')->where('property_type', '=', $request->type)->firstOrFail();
        ...
        $property->property_type_ID = $typeID->property_type_ID;
    ...
    {   
        ...
        return view('user.properties.edit',compact('property','features'));
    }
